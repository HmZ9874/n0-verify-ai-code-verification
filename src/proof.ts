...
export async function produceProofPack(options: { result: VerificationResult; config: N0Config; outputRoot?: string | undefined; signingKey?: string | undefined }) {
...
export function renderBadge(decision: VerificationResult["decision"]): string {
